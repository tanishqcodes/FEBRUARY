...
void solve()
{
    // By default we have a max priority queue , which is equavalent to a max heap 
    ...
    // for a reverse priority queue we have the following 

    priority_queue<int, vi, greater<int>>revpq;
    // This is equivalent to a min heap
