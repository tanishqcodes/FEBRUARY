...
void solve()
{
   ...
   li.remove(6);//removes all the occurences 
//    NO DIRECT ACCESS IN LIST 
//  INSERT IS FAST 
    auto idx = li.begin();
    idx++;
    // LIst is not contigous so we can't do li.begin() + integer_here since non contigous ! 
    li.insert(idx, 23);
